...
Chapter 2 introduces foundational concepts relevant to this thesis, including modern continuous integration (CI) systems, the core principles of Kubernetes, and the role of Kubernetes Operators. These topics provide the technical background required to understand the motivation and design choices behind the proposed system. Chapter 3 surveys related work to explore the current technical development and limitations and introduces the contribution of this work. Chapter 4 specifies the functional and non-functional requirements of the system, following the requirements analysis structure outlined in @bruegge2004object . In Chapter 5, the system architecture is developed, detailing the design rationale, subsystem decomposition, and the introduction of a Kubernetes-native orchestration model. Chapter 6 evaluates the system using the benchmarking framework implemented as part of this thesis, focusing on performance characteristics, scalability, and behavioral differences compared to previous execution modes. Finally, Chapter 7 concludes the thesis by summarizing the achieved results and outlining directions for future work.