...
I utilized several AI-based tools and digital assistants throughout the entire research and writing process of this thesis to improve the quality and clarity of the work. I used Grammarly to correct grammar, refine my writing style, and rephrase sentences to ensure coherence. To enhance the overall language quality and translate various segments of the text, I employed DeepL and Google Translate. I leveraged ChatGPT and Gemini across all chapters to generate initial drafts, expand on conceptual ideas, and develop illustrative examples. Additionally, I used GitHub Copilot to support the development of code and to generate code snippets for both the implementation and the methodology. I have critically reviewed, verified, and edited all content produced with these tools to ensure technical accuracy and logical consistency. I take full responsibility for the final content of this thesis.